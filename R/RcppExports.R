...
rcpp_prepare_data_identity <- function(seqnames, seqrunlens, start, strand, mcols, exclude_lower, exclude_upper) {
    .Call(`_ramr_rcpp_prepare_data_identity`, seqnames, seqrunlens, start, strand, mcols, exclude_lower, exclude_upper)
}

rcpp_prepare_data_linear <- function(seqnames, seqrunlens, start, strand, mcols, exclude_lower, exclude_upper) {
    .Call(`_ramr_rcpp_prepare_data_linear`, seqnames, seqrunlens, start, strand, mcols, exclude_lower, exclude_upper)
}
